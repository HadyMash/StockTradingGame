...
const stocks = [
  ...
  { stockName: "microsoft", stockQuantityInMarket: 17, stockPricePerUnit: 7.42 }
];
const players = [
  { playerName: "AI", stocksInPossession: {typeOfStock: stocks[1], quantityInPossession: 3}, playerMoney: 100 },
];
